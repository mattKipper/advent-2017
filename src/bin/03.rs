...
mod tests {
    ...
    fn one_to_twentythree() {
        let test_points = vec![ 
            TestPoint {x: 0, y: 0, distance: 0}, // 1
            TestPoint {x: 1, y: 0, distance: 1}, // 2
            TestPoint {x: 1, y: 1, distance: 2}, // 3
            TestPoint {x: 0, y: 1, distance: 1}, // 4
            TestPoint {x:-1, y: 1, distance: 2}, // 5
            TestPoint {x:-1, y: 0, distance: 1}, // 6
            TestPoint {x:-1, y:-1, distance: 2}, // 7
            TestPoint {x: 0, y:-1, distance: 1}, // 8
            TestPoint {x: 1, y:-1, distance: 2}, // 9
            TestPoint {x: 2, y:-1, distance: 3}, // 10
            TestPoint {x: 2, y: 0, distance: 2}, // 11
            TestPoint {x: 2, y: 1, distance: 3}, // 12
            TestPoint {x: 2, y: 2, distance: 4}, // 13
            TestPoint {x: 1, y: 2, distance: 3}, // 14
            TestPoint {x: 0, y: 2, distance: 2}, // 15
            TestPoint {x:-1, y: 2, distance: 3}, // 16
            TestPoint {x:-2, y: 2, distance: 4}, // 17
            TestPoint {x:-2, y: 1, distance: 3}, // 18
            TestPoint {x:-2, y: 0, distance: 2}, // 19
            TestPoint {x:-2, y:-1, distance: 3}, // 20
            TestPoint {x:-2, y:-2, distance: 4}, // 21
            TestPoint {x:-1, y:-2, distance: 3}, // 22
            TestPoint {x: 0, y:-2, distance: 2}  // 23
        ];
